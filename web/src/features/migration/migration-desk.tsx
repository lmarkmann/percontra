...
export function MigrationDesk() {
	...
	// A step is reachable from the rail only while its section is on the page.
			...
			<SidebarInset className="min-h-svh bg-background text-foreground">
				...
				>
						...
						<div className="flex flex-wrap items-center justify-between gap-4">
							...
							<div className="flex flex-wrap gap-3">
								<Button
									...
									disabled={isWorking}
									onClick={() =>
										void act("Loading public example", () =>
											load("example", {}),
										)
									}
								>
						...
						<>
							...
							<div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_22rem]">
								...
								>
									...
									postingsState.items.length === 0 ? (
										<p
											...
											className="text-caption text-muted-foreground"
										>
											This batch generated no postings. Every source row in it
											was either out of the frozen entity scope or is waiting on
											a decision.
										</p>
									) : null}
										...
										{comparison && (
											<div className="rounded-lg bg-muted p-3 text-caption">
												<p className="font-semibold">
													{comparison.matched} of {comparison.expected}{" "}
													reference rows match on {comparison.fields.length}{" "}
													fields.
												</p>
												<p>
								...
								<aside className="space-y-4 rounded-xl border bg-card p-5">
									...
									<p className="text-caption text-muted-foreground">
										These gaps come from the supplied Mapping Gaps sheet.
										Changing a decision invalidates only dependent approvals.
									</p>
							...
							<div className="space-y-3">
								...
								<div className="flex flex-wrap gap-3">
									...
									<Button
										variant="outline"
										disabled={
											!liveReady || accountPlan.length === 0 || isWorking
										}
										onClick={() =>
					...
					<footer className="pb-6 text-label text-muted-foreground">
						...
						exports do not prove destination acceptance. Private client
						workbooks are never bundled with the public demo.
					</footer>
				</main>
