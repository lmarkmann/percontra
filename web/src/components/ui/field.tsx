...
function FieldDescription({ className, ...props }: ComponentProps<"p">) {
	return (
		<p
			...
			className={cn(
				"text-left text-caption leading-snug font-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
...
function FieldError({
	...
	return (
		<div
			...
			className={cn(
				"text-caption leading-snug font-normal text-destructive",
				className,
			)}
			{...props}
		>
